<x-field name="name" label="Nama" type="text" required maxlength="255" :value="old('name', data_get($facility ?? null, 'name'))" />
<x-textarea name="description" label="Deskripsi" maxlength="5000" :value="old('description', data_get($facility ?? null, 'description'))" />
